...
// Blog posts are long-form — Claude if available.
...
export async function genMetaAd(ctx: LaunchContext) {
...
export async function genLinkedInAssets(ctx: LaunchContext) {
  const res = await generateObject({
    model: openrouter(MODEL),
...
export async function genTikTokAssets(ctx: LaunchContext) {
  const res = await generateObject({
    model: openrouter(MODEL),
...
export async function genTwitterThread(ctx: LaunchContext) {
  const res = await generateObject({
    model: openrouter(MODEL),
...
export async function genRedditPosts(ctx: LaunchContext, founderVoice?: string) {
  ...
  // Second pass: self-critique and rewrite if too promotional
...
export async function genEmailSequence(ctx: LaunchContext) {
  const res = await generateObject({
    model: openrouter(MODEL),
...
export async function genBlogPost(ctx: LaunchContext) {
  const res = await generateObject({
    model: STRATEGIC(),
...
export async function genLandingPage(ctx: LaunchContext) {
  const res = await generateObject({
    model: openrouter(MODEL),
